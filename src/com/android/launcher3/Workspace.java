...
public class Workspace extends SmoothPagedView
    ...
    */
    ...
    public boolean enterOverviewMode() {
        ...
        //setWallpaper and appwidget overview mark by jiapx 20150805
        //delete by jiapx
//      enableOverviewMode(true, -1, true);
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        ...
        // The outline is used to visualize where the item will land if dropped　mark by jiapx
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    class FolderCreationAlarmListener implements OnAlarmListener {
        ...
        public void onAlarm(Alarm alarm) {
            ...
            //delete by jiapx 20150805 for shield folder
