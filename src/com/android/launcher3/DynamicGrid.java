...
class DeviceProfile {
	...
	public void layout(Launcher launcher) {
        ...
        //modify by jiapx delete area is top hasVerticalBarLayout = true;
        ...
        //modify by jiapx hotseat to bottom gone
        if (!hasVerticalBarLayout) {
            // Vertical hotseat
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
            	...
            	// modify by jiapx show pageIndicator vertical
...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Nexus S",
                296, 491.33f,  2, 4,  90, 25f, (hasAA ? 5 : 4), 48));
//        deviceProfiles.add(new DeviceProfile("Nexus 4",
//                359, 518,  2, 4,  80, 13, (hasAA ? 5 : 4), 20));
        // The tablet profile is odd in that the landscape orientation
        // also includes the nav bar on the side
        //modify by jiapx
//        deviceProfiles.add(new DeviceProfile("Nexus 7",
//                575, 904,  2, 4,  80, 25f,  7, 20));
        // Larger tablet profiles always have system bars on the top & bottom
//        deviceProfiles.add(new DeviceProfile("Nexus 10",
//                727, 1207,  2, 4,  150, 25f,  7, 20));
        /*
        deviceProfiles.add(new DeviceProfile("Nexus 7",
