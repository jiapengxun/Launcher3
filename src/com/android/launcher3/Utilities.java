...
final class Utilities {
    ...
    static Bitmap createIconBitmap(Drawable icon, Context context) {
        synchronized (sCanvas) { // we share the statics :-(
            ...
            final boolean debug = false;//add backgroud color to app icon by jiapx
            if (debug) {
            ...
            //add by jiapx add backgroundImage for app icon
//            if (true){
//            	Log.d(TAG, context.getPackageName());
...
//            }
    ...
    //add by jiapx 20150805
    @SuppressWarnings("deprecation")
	static Bitmap createIconBitmapForCustomer(Context context, int resId){
    	Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), resId);
    	Drawable drawable = new BitmapDrawable(bitmap);
    	return createIconBitmap(drawable, context);
    }
    /**
